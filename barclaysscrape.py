...
config.read("barclaysscrape.ini")

surname = config.get("barclaysscrape", "surname")
membershipnum = config.get("barclaysscrape", "membershipnum")
passcode = config.get("barclaysscrape", "passcode")
password = config.get("barclaysscrape", "password")
...
#driver.find_elements_by_xpath("//*[@id='idForScrollFeature']/div[1]")[0].send_keys(str(first))
#driver.find_elements_by_xpath("//*[@id='idForScrollFeature']/div[1]")[0].send_keys(str(second))

driver.find_element_by_xpath("//div[@name='firstMemorableCharacter']/div").send_keys(first)
driver.find_element_by_xpath("//div[@name='secondMemorableCharacter']/div").send_keys(second)
driver.find_element_by_xpath("//button").click()
time.sleep(5)
n = shotnhtml(driver, n)
